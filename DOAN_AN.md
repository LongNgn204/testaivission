...
- **Cách hoạt động:** Hiển thị các chữ cái với kích thước giảm dần, người dùng đọc từ xa
...
- **Cách hoạt động:** Hiển thị các bảng Ishihara, người dùng nhập số họ nhìn thấy
- **Kết quả:** Bình thường / Mù màu đỏ-xanh / Mù màu toàn bộ
- **File:** `components/ColorBlindTest.tsx`, `services/colorBlindService.ts`

#### [object Object]tigmatism Test** (Kiểm tra loạn thị)
- **Mục đích:** Phát hiện loạn thị (sai khúc xạ)
- **Cách hoạt động:** Hiển thị bánh xe Astigmatism, người dùng chọn hướng mờ nhất
...
- **Cách hoạt động:** Hiển thị lưới ô vuông, người dùng đánh dấu các ô bị cong/mờ
...
- **Cách hoạt động:** Hiển thị 2 nửa màn hình, người dùng chọn bên nào chữ rõ hơn
...
- **Tính năng:**
  ...
  - [object Object] tiết từng bài test
  - 📊 Thống kê tổng hợp
...
- **Tính năng:**
  ...
  - 📊 Xem streak hiện tại và cao nhất
...
- **Tính năng:**
  ...
  - [object Object]ỗ trợ màn hình lớn
...
**Bước 1:** Truy cập trang chủ → Nhấn "Bắt đầu kiểm tra"
**Bước 2:** Đăng nhập → Nhập email và mật khẩu
**Bước 3:** Cài đặt cá nhân → Chọn lịch trình, trả lời câu hỏi
**Bước 4:** Chọn bài test → Snellen được khuyến nghị
**Bước 5:** Làm bài test → Đọc hướng dẫn, làm theo
**Bước 6:** Xem phân tích AI → Xem kết quả chi tiết

### 2️⃣ **Theo dõi tiến độ**

- Vào trang "Tiến độ" → Xem biểu đồ xu hướng Snellen
- Vào trang "Lịch sử" → Xem tất cả bài test đã làm
- Xuất PDF → Lưu báo cáo

### 3️⃣ **Đặt nhắc nhở**

- Vào trang "Nhắc nhở" → Nhấn "+ Thêm nhắc nhở"
- Chọn loại, tần suất, giờ → Nhấn "Lưu"

### 4️⃣ **Tìm bệnh viện**

- Vào trang "Bệnh viện" → Cho phép truy cập vị trí
- Xem danh sách bệnh viện → Nhấn "Chỉ đường"
...
- **Google Gemini AI** - Mô hình AI và API
