...
const HOSPITALS_DATABASE: Hospital[] = [
  ...
  },
  {
    ...
    nameEn: 'Japan International Eye Hospital (JIEH)',
    address: '120 Nguyễn Văn Trỗi, Phú Nhuận, TP.HCM',
    addressEn: '120 Nguyen Van Troi, Phu Nhuan, HCMC',
    phone: '028 3930 6655',
    rating: 4.8,
    reviewCount: 890,
    distance: 0,
    ...
    googleMapsUrl: 'https://maps.app.goo.gl/t2ZskEgYCo7B5uWk6',
  },
  {
    id: 'kangnam',
    ...
    website: 'https://keangnamkorea.com/',
    googleMapsUrl: 'https://www.google.com/maps/place/10.798734,106.676956',
  },
  {
    id: 'saigon-eye',
    name: 'Bệnh viện Mắt Sài Gòn',
    nameEn: 'Saigon Eye Hospital',
    address: '77 phố Nguyễn Du, Phường Hai Bà Trưng, TP. Hà Nội',
    addressEn: '77 phố Nguyễn Du, Phường Hai Bà Trưng, TP. Hà Nội',
    phone: '098 626 0004',
    rating: 4.4,
    reviewCount: 780,
    distance: 0,
    ...
    website: 'https://www.matsaigon.com/',
