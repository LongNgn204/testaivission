...
// 🏥 DATABASE: Top Eye Hospitals in Vietnam (verified & updated)
const HOSPITALS_DATABASE: Hospital[] = [
  {
    id: 'bv-mat-tw',
    name: 'Bệnh viện Mắt Trung ương',
    nameEn: 'Vietnam National Eye Hospital (VNIO)',
    ...
    lat: 21.022736,
    lng: 105.854431,
    specialties: ['Phẫu thuật Lasik', 'Đục thủy tinh thể', 'Tật khúc xạ', 'Bệnh võng mạc', 'Glôcôm', 'Phẫu thuật tạo hình', 'Mắt trẻ em'],
    specialtiesEn: ['Lasik Surgery', 'Cataract', 'Refractive Error', 'Retinal Disease', 'Glaucoma', 'Oculoplastic Surgery', 'Pediatric Ophthalmology'],
    emergencyService: true,
    insuranceAccepted: ['BHYT', 'Bảo Minh', 'Bảo Việt', 'Prudential', 'AIA', 'Manulife', 'Liberty'],
    openingHours: '7:00 - 17:00 (T2-T6), 7:00 - 12:00 (T7), Nghỉ CN',
    website: 'https://vnio.vn',
    googleMapsUrl: 'https://www.google.com/maps/place/21.022736,105.854431',
  },
  {
    id: 'bv-mat-tphcm',
    ...
    addressEn: '280 Dien Bien Phu, Ward 7, District 3, HCMC',
    phone: '028 3829 4411',
    rating: 4.6,
    reviewCount: 2100,
    distance: 0,
    lat: 10.776942,
    lng: 106.693787,
    specialties: ['Phẫu thuật Lasik', 'Đục thủy tinh thể', 'Bệnh võng mạc', 'Mắt trẻ em', 'Glôcôm', 'Phẫu thuật tạo hình', 'Tật khúc xạ'],
    specialtiesEn: ['Lasik Surgery', 'Cataract', 'Retinal Disease', 'Pediatric Ophthalmology', 'Glaucoma', 'Oculoplastic Surgery', 'Refractive Error'],
    emergencyService: true,
    insuranceAccepted: ['BHYT', 'Bảo Minh', 'Bảo Việt', 'AIA', 'Manulife', 'Prudential', 'Liberty', 'Generali'],
    openingHours: '7:00 - 17:00 (T2-T6), 7:00 - 12:00 (T7), Cấp cứu 24/7',
    website: 'https://bvmat.org.vn',
    googleMapsUrl: 'https://www.google.com/maps/place/10.776942,106.693787',
  },
  {
    id: 'japan-ivs',
    name: 'Hệ thống Nhãn khoa Nhật Bản',
    nameEn: 'Japan International Vision Support (IVS)',
    address: '79 Trần Quốc Thảo, Phường Võ Thị Sáu, Quận 3, TP.HCM',
    addressEn: '79 Tran Quoc Thao, Vo Thi Sau Ward, District 3, HCMC',
    phone: '028 3930 6655',
    rating: 4.8,
    reviewCount: 890,
    distance: 0,
    lat: 10.780628,
    lng: 106.688583,
    specialties: ['Phẫu thuật Lasik Femto', 'ICL (Implantable Contact Lens)', 'Tật khúc xạ', 'Đục thủy tinh thể', 'Khám tổng quát', 'Kính tiếp xúc'],
    specialtiesEn: ['Femto Lasik Surgery', 'ICL (Implantable Contact Lens)', 'Refractive Error', 'Cataract', 'General Checkup', 'Contact Lens'],
    emergencyService: false,
    insuranceAccepted: ['Bảo Minh', 'Bảo Việt', 'Prudential', 'AIA', 'Manulife', 'Liberty'],
    openingHours: '8:00 - 20:00 (T2-CN), Không nghỉ trưa',
    website: 'https://japan-ivs.vn',
    googleMapsUrl: 'https://www.google.com/maps/place/10.780628,106.688583',
  },
  {
    id: 'kangnam',
    name: 'Bệnh viện Mắt Quốc tế Kangnam',
    nameEn: 'Kangnam International Eye Hospital',
    address: '122 Nguyễn Văn Trỗi, Phường 11, Quận Phú Nhuận, TP.HCM',
    addressEn: '122 Nguyen Van Troi, Ward 11, Phu Nhuan District, HCMC',
    phone: '028 3844 9333',
    rating: 4.7,
    reviewCount: 1560,
    distance: 0,
    lat: 10.798734,
    lng: 106.676956,
    specialties: ['Phẫu thuật Lasik', 'Smile Pro', 'Đục thủy tinh thể', 'Bệnh võng mạc', 'Mắt trẻ em', 'Phẫu thuật tạo hình', 'Glôcôm'],
    specialtiesEn: ['Lasik Surgery', 'Smile Pro', 'Cataract', 'Retinal Disease', 'Pediatric Ophthalmology', 'Oculoplastic Surgery', 'Glaucoma'],
    emergencyService: true,
    insuranceAccepted: ['BHYT', 'Bảo Minh', 'Bảo Việt', 'Prudential', 'AIA', 'Manulife', 'Liberty', 'Generali', 'FWD'],
    openingHours: '7:30 - 17:30 (T2-T6), 7:30 - 12:00 (T7), Nghỉ CN',
    website: 'https://benhvienmat.com',
    googleMapsUrl: 'https://www.google.com/maps/place/10.798734,106.676956',
  },
  {
    id: 'saigon-eye',
    name: 'Trung tâm Mắt Sài Gòn',
    nameEn: 'Saigon Eye Center',
    address: '143 Hai Bà Trưng, Phường Đa Kao, Quận 1, TP.HCM',
    addressEn: '143 Hai Ba Trung, Da Kao Ward, District 1, HCMC',
    phone: '028 3829 8866',
    rating: 4.4,
    reviewCount: 780,
    distance: 0,
    lat: 10.772652,
    lng: 106.700676,
    specialties: ['Phẫu thuật Lasik', 'Tật khúc xạ', 'Khám tổng quát', 'Đục thủy tinh thể', 'Kính áp tròng'],
    specialtiesEn: ['Lasik Surgery', 'Refractive Error', 'General Checkup', 'Cataract', 'Contact Lens'],
    emergencyService: false,
    insuranceAccepted: ['Bảo Minh', 'Bảo Việt', 'AIA', 'Prudential'],
    openingHours: '8:00 - 18:00 (T2-T6), 8:00 - 12:00 (T7), Nghỉ CN',
    website: 'https://www.saigoneyecenter.com',
    googleMapsUrl: 'https://www.google.com/maps/place/10.772652,106.700676',
  },
];
