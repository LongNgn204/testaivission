...
import { EyeIcon, DropletsIcon, TargetIcon, GridIcon, CircleDotIcon, Trash2Icon, CalendarIcon, FileTextIcon } from '../components/ui/Icons';
...
const ICONS: Record<TestType, React.ElementType> = {
  snellen: EyeIcon,
  colorblind: DropletsIcon,
  astigmatism: TargetIcon,
  amsler: GridIcon,
  duochrome: CircleDotIcon,
};
